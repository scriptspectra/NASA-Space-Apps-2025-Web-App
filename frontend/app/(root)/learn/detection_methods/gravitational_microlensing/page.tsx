...
const microlensingPage = () => {
  return (
    <div className="p-6 md:pl-24 space-y-8">
      ...
      {/* How It Works */}
      <div className="dark:bg-[#2A2A2A] bg-white p-6 rounded-md border-l-4 border-[#D4481E] shadow-sm">
      ...
      <div className="dark:bg-[#2A2A2A] bg-white p-6 rounded-md border-l-4 border-[#D4481E] shadow-sm">
        <h2 className="text-2xl font-semibold text-[#D4481E] mb-2">What Microlensing Reveals</h2>
      ...
      <div className="dark:bg-[#2A2A2A] bg-white p-6 rounded-md border-l-4 border-[#D4481E] shadow-sm">
        <h2 className="text-2xl font-semibold text-[#D4481E] mb-2">Gravitational Lensing — The Bigger Picture</h2>
        <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 mb-2">
