  ...
  return (
    <div className="p-6 md:pl-24 space-y-8">
      ...
      <div className="dark:bg-[#2A2A2A] bg-white rounded-md border-l-4 border-[#D4481E] p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-[#D4481E] mb-2">Astrometry — Measuring the Tiny Wobble</h2>
        <p className="text-slate-700 dark:text-slate-300 mb-2">
      ...
      <div className="dark:bg-[#2A2A2A] bg-white rounded-md border-l-4 border-[#D4481E] p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-[#D4481E] mb-2">Other Less Common Methods</h2>

        {/* Timing Variations */}
        <h3 className="text-xl font-semibold text-[#D4481E] mb-1">Timing Variations</h3>
        <ul className="list-disc list-inside text-slate-600 dark:text-slate-400 mb-2">
        ...
        <h3 className="text-xl font-semibold text-[#D4481E] mb-1">Eclipsing Binary Timing</h3>
        <p className="text-slate-700 dark:text-slate-300 mb-2">
        ...
        {/* Polarimetry */}
        <h3 className="text-xl font-semibold text-[#D4481E] mb-1">Polarimetry</h3>
        <p className="text-slate-700 dark:text-slate-300 mb-2">
        ...
        {/* Radio Emission */}
        <h3 className="text-xl font-semibold text-[#D4481E] mb-1">Radio Emission</h3>
        <p className="text-slate-700 dark:text-slate-300 mb-2">
      ...
      <div className="dark:bg-[#2A2A2A] bg-white rounded-md border-l-4 border-[#D4481E] p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-[#D4481E] mb-2">Why These Methods Matter</h2>
        <ul className="list-disc list-inside text-slate-600 dark:text-slate-400 mb-2">
